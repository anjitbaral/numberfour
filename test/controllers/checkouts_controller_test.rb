...
class CheckoutsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create checkout" do
    assert_difference('Checkout.count') do
      post checkouts_url, params: { checkout: { cost: @checkout.cost, treatment: @checkout.treatment } }
    end
  ...
  test "should update checkout" do
    patch checkout_url(@checkout), params: { checkout: { cost: @checkout.cost, treatment: @checkout.treatment } }
